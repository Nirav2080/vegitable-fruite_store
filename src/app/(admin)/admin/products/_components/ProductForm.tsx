              ...
              <CardContent>
                <div className="space-y-6">
                  {variantFields.map((field, index) => {
                    ...
                    return (
                    <div key={field.id} className="p-4 border border-border/30 rounded-xl relative space-y-4">
                      <Button 
                        type="button" 
                        variant="destructive" 
                        size="icon" 
          ...
          <FormField
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                    ...
                    name="isOrganic"
                    render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border border-border/30 p-4">
                        <FormControl>
